...
// Pure range helpers live in mmr/shields.ts (no Firebase), so viewmodels and
// their tests can use them without loading the Functions SDK.
export { isHibernating, shieldedWeekIds, type PublicHibernation } from '../mmr/shields';
